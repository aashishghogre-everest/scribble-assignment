...
- When implementing tasks, update the corresponding `specs/.../tasks.md` entry to mark the task completed by modifying the existing row (check the box). Do not add duplicate rows—always edit the existing task line to reflect completion.
